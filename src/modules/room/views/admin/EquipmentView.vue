...
const headers = [{ title: 'Phòng', key: 'roomId', width: 100 },{ title: 'Thiết bị', key: 'equipmentName' },{ title: 'Trạng thái', key: 'status', width: 130 },{ title: '', key: 'actions', width: 60, sortable: false }]
